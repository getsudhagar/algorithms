package com.learn.algo.backtrack;
...
public class NQueenProblem {
	public List<String[]> solveNQueens(int n) {
		...
		solveNQueensUsingBackTracking(queens, 0, solutions);

		return solutions;
	}

	private void solveNQueensUsingBackTracking(int[] queens, int currentRow, List<String[]> solutions) {
		...
		for (int j = 0; j < queens.length; j++) {
			...
			if (isValid(queens, currentRow)) {
				solveNQueensUsingBackTracking(queens, currentRow + 1, solutions);
			}
		}
	}
